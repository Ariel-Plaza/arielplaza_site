...
// Configuración del slider, incluyendo ajustes responsivos
...
const cardData = [
  {
    icon: htmlIcon,
    title: "HTML & CSS",
    info: "Experiencia destacada en la creación de interfaces web estéticas, funcionales, accesibles y responsivas.",
  },
  {
    icon: jsIcon,
    title: "Javascript",
